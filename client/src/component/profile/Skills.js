...
const frontEnd = [
  ...
  { icon: JqueryIcon, title: "JQUERY", text: "라이브러리를 사용하여 DOM 객체를 조작할 수 있다." },
  { icon: ReactIcon, title: "REACT", text: "각종 라이브러리를 사용할 수 있고 함수형 컴포넌트를 사용할 수 있다." },
];

const backEnd = [
  { icon: JavaIcon, title: "JAVA", text: "객체지향적 사고를 할 수 있다. JAVA8 문법을 사용할 수 있다." },
  {
    icon: SpringIcon,
    title: "SPRING BOOT",
    text: "REST API 서버를 구축할 수 있다. Security, Web Socket등 라이브러리를 사용할 수 있다.",
  },
  {
    icon: MysqlIcon,
    title: "MYSQL",
    text: "Join을 사용하여 SQL을 작성할 수 있으며 프로시져 및 트리거를 사용할 수 있다.",
  },
];

const devOps = [
  { icon: LinuxIcon, title: "LINUX", text: "기본 명령어를 사용할 수 있으며 웹서버를 구성할 수 있다." },
  {
    icon: NginxIcon,
    title: "NGINX",
    text: "리버스 프록시를 구성할 수 있으며 ssl 인증서로 https 설정을 할 수 있다.",
  },
  {
    icon: AwsIcon,
    title: "AWS",
    text: "ec2를 사용하여 서버를 구성할 수 있고 rds로 데이터베이스를 구성할 수 있다.",
  },
  {
    icon: GitIcon,
    title: "GIT",
    text: "버전관리를 할 수 있으며, pr 과 review를 할 수 있다.",
  },
];
